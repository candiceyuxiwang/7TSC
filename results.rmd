...
```{r}
#11/27: reshape data into wide format (clean up this part later)
# first run R code section 1
fullmaskdata_wide <- data.frame("SC_left_Aversive" = leftSCaver, "SC_left_Neutral" = leftSCneu, "SC_right_Aversive" = rightSCaver, "SC_right_Neutral" = rightSCneu, "IC_left_Aversive" = leftICaver, "IC_left_Neutral" = leftICneu, "IC_right_Aversive" = rightICaver, "IC_right_Neutral" = rightICneu)
```
```{r}
# next, run the R code section where visprop data is loaded
vispropdata_wide <- data.frame("SC_left_Aversive" = leftSCaver, "SC_left_Neutral" = leftSCneu, "SC_right_Aversive" = rightSCaver, "SC_right_Neutral" = rightSCneu, "IC_left_Aversive" = leftICaver, "IC_left_Neutral" = leftICneu, "IC_right_Aversive" = rightICaver, "IC_right_Neutral" = rightICneu)
```